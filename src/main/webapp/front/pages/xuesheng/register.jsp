...
<form class="layui-form login-form" lay-filter="myForm"
      style="width: 500px;height: 500px;border-width: 10px;border-color: var(--publicMainColor);border-style: solid;">
    ...
    <div class="zhuce">            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
            ...
            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                ...
                <label v-if="false"
                       :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"110px","fontSize":"16px","borderStyle":"solid"}'
                       class="form-label">学生姓名：</label>
                <input :style='{"padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"44px"}'
                       lay-verify="required" type="text" id="xueshengName" name="xueshengName"
...
<!-- 手机号 -->
            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                ...
                <label v-if="false"
                       :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"110px","fontSize":"16px","borderStyle":"solid"}'
                       class="form-label">学生手机号：</label>
                <input :style='{"padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"44px"}'
                       lay-verify="phone|required" type="text" id="xueshengPhone" name="xueshengPhone"
                       placeholder="请输入学生手机号" autocomplete="off"
                       class="layui-input">
            </div>
        <!-- 身份证号 -->
            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                ...
                <label v-if="false"
                       :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"110px","fontSize":"16px","borderStyle":"solid"}'
                       class="form-label">学生身份证号：</label>
                <input :style='{"padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"44px"}'
                       lay-verify="identity|required" type="text" id="xueshengIdNumber"
                       name="xueshengIdNumber" placeholder="请输入学生身份证号"
                       autocomplete="off" class="layui-input">
            </div>
                        <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
...
<!--                            <option value="">请选择性别</option>-->
                ...
                <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                     class="inpotdivBackGround">
                    <div :style='{"margin-top":"10px","padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}'>
                        <select name="xueyuanTypes" id="xueyuanTypes">
<!--                            <option value="">请选择学院</option>-->
                            <option v-for="(item,index) in xueyuanTypesList" :value="item.codeIndex"
                                    :key="item.codeIndex">{{ item.indexName }}
                            </option>
                        </select>
                    </div>
...
<!--                            <option value="">请选择班级</option>-->
                            <option v-for="(item,index) in banjiTypesList" :value="item.codeIndex"
                                    :key="item.codeIndex">{{ item.indexName }}
                            </option>
                        </select>
                    </div>
...
<!-- 邮箱 -->
            <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}'
                ...
                <label v-if="false"
                       :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"110px","fontSize":"16px","borderStyle":"solid"}'
                       class="form-label">学生邮箱：</label>
                <input :style='{"padding":"0 10px","boxShadow":"0 0 6px var(--publicMainColor)","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(59, 46, 126, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"1px","width":"100%","fontSize":"14px","borderStyle":"solid","height":"44px"}'
                       lay-verify="email|required" type="text" id="xueshengEmail" name="xueshengEmail"
                       placeholder="请输入学生邮箱" autocomplete="off"
                       class="layui-input">
            </div>
</div>
<div style="position: sticky;bottom: 0;background-color: #fff;height: 80px;padding-top: 10px;">
    <div class="layui-btn layui-btn-fluid layui-btn-danger btn-submit sub_backgroundColor" lay-submit lay-filter="register" style="width:200px;margin: 0 auto;height: 82px;line-height: 80px;background-color: var(--publicMainColor);border-top-left-radius: 15px;border-top-right-radius: 15px;">注册</div>
    <p :style='{"color":"rgba(59, 46, 126, 1)","fontSize":"12px"}' class="returnPosition" style="margin-top: 30px;"><a style=" color: var(--publicMainColor);" href="javascript:window.location.href='../login/login.jsp'">已有账号登录</a></p>
</div>
</form></div>
