    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.xueshengName" placeholder="学生姓名" autocomplete="off"
                       class="search-input">                                 
                <select class="search-input" v-model="searchForm.jinyongTypes">
                    <option value="" selected>请选择账户状态</option>
                    <option v-for="(item,index) in jinyongTypesList" v-bind:key="index"
                        ...
                        <div v-if="isAuth('xuesheng','新增')"  @click="jump('../xuesheng/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
            </div>
        </div>
