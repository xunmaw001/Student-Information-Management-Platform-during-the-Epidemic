 ...
 <div class="sec1-left fl">
            ...
            <div class="right-container sub_borderColor" :style='{"backgroundColor":"#fff","padding":"20px","boxShadow":"0px rgba(255,0,0,.8)","margin":"0","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid","width":"80%"}'>
                <form class="layui-form"  v-if="!changePassword">
                    ...
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        ...
                        <div class="layui-input-block input">
                            <input type="text" v-model="detail.xueshengName" name="xueshengName" id="xueshengName" lay-verify="required" placeholder="学生姓名" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        <label  :style='{"width":"110px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"left"}' class="layui-form-label">
                        ...
                        <div class="layui-input-block input">
                            <input type="text" v-model="detail.xueshengPhone" name="xueshengPhone" id="xueshengPhone" lay-verify="required|phone" placeholder="学生手机号" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        <label  :style='{"width":"110px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"left"}' class="layui-form-label">
                        ...
                        <div class="layui-input-block input">
                            <input type="text" v-model="detail.xueshengIdNumber" name="xueshengIdNumber" id="xueshengIdNumber" lay-verify="required|identity" placeholder="学生身份证号" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        ...
                        <div class="layui-input-block">
                            <img id="xueshengPhotoImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 3px rgba(160, 67, 26, 1)","borderColor":"rgba(135, 206, 250, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' :src="baseUrl+detail.xueshengPhoto">
                            <input type="hidden" v-model="detail.xueshengPhoto" id="xueshengPhoto" name="xueshengPhoto" />
                        </div>
                    </div>
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        <label  :style='{"width":"110px","padding":"0 12px 0 0","fontSize":"15px","color":"#333","textAlign":"left"}' style="opacity: 0;" class="layui-form-label">
                    ...
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        ...
                        <div class="layui-input-block select">
                            <el-select v-model="detail.xueyuanTypes" filterable disabled="true" placeholder="请选择学院" style="border-color: var(--publicMainColor, #808080);" name="xueyuanTypes" id="xueyuanTypes">
                                <el-option
                                        v-for="(item,index) in xueyuanTypesList"
                                        v-bind:key="item.codeIndex"
                                        :label="item.indexName"
                                        :value="item.codeIndex">
                                </el-option>
                    ...
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        ...
                        <div class="layui-input-block select">
                            <el-select v-model="detail.banjiTypes" filterable disabled="true" placeholder="请选择班级" style="border-color: var(--publicMainColor, #808080);" name="banjiTypes" id="banjiTypes">
                                <el-option
                                        v-for="(item,index) in banjiTypesList"
                                        v-bind:key="item.codeIndex"
                                        :label="item.indexName"
                                        :value="item.codeIndex">
                                </el-option>
                    ...
                    <div class="layui-form-item main_borderColor"  :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"#fff","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                        ...
                        <div class="layui-input-block input">
                            <input type="text" v-model="detail.xueshengEmail" name="xueshengEmail" id="xueshengEmail" lay-verify="required" placeholder="学生邮箱" autocomplete="off" class="layui-input">
                        </div>
                    </div>
    ...
    <script>
        var vue = new Vue({
            ...
            methods: {
                ...
                queren() {
                    ...
                    layui.http.request(`xuesheng/updatePassword`, 'get', {
        ...
        layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'laydate', 'form', 'upload'], function() {
            ...
            // 上传 文件/图片
            // 学生头像的文件上传
            var xueshengPhotoUpload = upload.render({
                //绑定元素
