    ...
    <script>
        ...
        var vue = new Vue({
            ...
            methods: {
                //分享
                share(){
                    let element = createElement("http://localhost:8080/yqxueshengxinxi/front/index.jsp?url="+"./pages/news/detail.jsp?id="+this.id);
                    element.select();
                ...
                newsYuyue(){
                    ...
                    // localStorage.setItem('newsId', _this.detail.id);
                    // _this.jump("../newsOrder/add.jsp");
        ...
        layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'util'], function () {
            ...
            localStorage.setItem("goUtl","./pages/news/detail.jsp?id="+ http.getParam('id'))
