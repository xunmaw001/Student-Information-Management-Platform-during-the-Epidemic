    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div style="width: 760px;margin-top: 13px">
                ...
                <div style="width: 100%;height: auto;overflow: hidden;" class="new_box">
                    <ul style="width: 100%;height: auto;overflow: hidden;margin-top: 40px;">
                        <a @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList">
                            <li>
                                <img :src="baseUrl+item.newsPhoto" style="float: left;display: block;height:221px;width:20%;" v-if="index%2==0"/>
                                <img :src="baseUrl+item.newsPhoto" style="float: right;display: block;height:221px;width:20%;" v-if="index%2==1"/>
                                <div class="new_p" style="width: 75%;float: right;text-align: left;margin-left: 25px;">
                                    ...
                                    <p class="p2">{{item.newsName}}</p>
                                    <p class="p3">{{myFilters(item.newsContent)}}</p>
                                </div>
                            </li>
                        </a>
                    </ul>
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.newsName" placeholder="新闻名称" autocomplete="off"
                       class="search-input">         
                                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        <div id="btn-search" class="button-submit"><i class="layui-icon layui-icon-search"></i>搜索</div>
                        <div v-if="isAuth('news','新增')"  @click="jump('../news/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
                <div class="tags tags1">
                    ...
                    <ul>
                        ...
                        <li v-for="(item,index) in newsTypesList" :key="item.codeIndex" :index="item.codeIndex" class="thisTableType-search" >
