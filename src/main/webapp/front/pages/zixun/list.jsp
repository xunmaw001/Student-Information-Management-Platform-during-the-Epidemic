    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div style="width: 760px;margin-top: 13px">
                ...
                <div style="width: 100%;height: auto;overflow: hidden;" class="new_box">
                    <ul style="width: 100%;height: auto;overflow: hidden;margin-top: 40px;">
                        <a @click="jump('../zixun/detail.jsp?id='+item.id);" v-for="(item,index) in dataList">
                            <li>
                                <img :src="baseUrl+item.zixunPhoto" style="float: left;display: block;height:221px;width:20%;" v-if="index%2==0"/>
                                <img :src="baseUrl+item.zixunPhoto" style="float: right;display: block;height:221px;width:20%;" v-if="index%2==1"/>
                                <div class="new_p" style="width: 75%;float: right;text-align: left;margin-left: 25px;">
                                    ...
                                    <p class="p2">{{item.zixunName}}</p>
                                    <p class="p3">{{myFilters(item.zixunContent)}}</p>
                                </div>
                            </li>
                        </a>
                    </ul>
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.zixunName" placeholder="资讯名称" autocomplete="off"
                       class="search-input">         
                                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        <div id="btn-search" class="button-submit"><i class="layui-icon layui-icon-search"></i>搜索</div>
                        <div v-if="isAuth('zixun','新增')"  @click="jump('../zixun/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
                <div class="tags tags1">
                    ...
                    <ul>
                        <li class="thisTableType-search">
                            <a :class='searchForm.zixunTypes=="" || searchForm.zixunTypes==null?"thisTableType-search-hover":""'>全部</a>
                        </li>
                        <li v-for="(item,index) in zixunTypesList" :key="item.codeIndex" :index="item.codeIndex" class="thisTableType-search" >
                            <a :class='searchForm.zixunTypes==item.codeIndex?"thisTableType-search-hover":""'>{{item.indexName}}</a>
                        </li>
                    </ul>
                </div>
            </div>
