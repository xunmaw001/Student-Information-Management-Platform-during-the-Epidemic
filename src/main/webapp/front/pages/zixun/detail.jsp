    ...
    <div id="app">
        ...
        <div class="news-container">
            ...
            <div style="width: 980px;margin: 0 auto">
                <img width="100%" :src="baseUrl+detail.zixunPhoto">
            </div>
            <div class="content" style="word-break: break-all;" v-html="myFilters(detail.zixunContent)">
            </div>
    ...
    <script>
        ...
        var vue = new Vue({
            ...
            methods: {
                //分享
                share(){
                    let element = createElement("http://localhost:8080/yqxueshengxinxi/front/index.jsp?url="+"./pages/zixun/detail.jsp?id="+this.id);
                    element.select();
        ...
        layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'util'], function () {
            ...
            localStorage.setItem("goUtl","./pages/zixun/detail.jsp?id="+ http.getParam('id'))
            ...
            vue.detail.id = id;
            // 详情信息
            http.request('zixun/detail/' + id, 'get', {}, function(res) {
                vue.detail = res.data;
                vue.title = vue.detail.zixunName;
                    vue.detail.zixunContent = vue.detail.zixunContent.replaceAll("src=\"upload/","src=\""+vue.baseUrl+"upload/").replaceAll(/<img/g,'<img style="width: 100%;"');
            });
        });
    </script>
</body>
