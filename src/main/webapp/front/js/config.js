...
var centerMenu = [
    ...
    ,{
        name: '返校申请',
        url: '../fanxiang/list.jsp'
    }
    ,{
        name: '接受地',
        url: '../jieshoudi/list.jsp'
    }
    ,{
        name: '接受地前往',
        url: '../jieshoudiQianwang/list.jsp'
    }
    ,{
        name: '学校文件收藏',
        url: '../wenjianbiaoCollection/list.jsp'
    }
    ,{
        name: '学生健康',
        url: '../xueshengJiankang/list.jsp'
    }
    ,{
        name: '每日记录',
        url: '../xueshengJilu/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '通知',
        url: './pages/tongzhi/list.jsp'
    },
    {
        name: '学校文件',
        url: './pages/wenjianbiao/list.jsp'
    },
    {
        name: '资讯',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/yqxueshengxinxi/admin/dist/index.jsp#/login";
