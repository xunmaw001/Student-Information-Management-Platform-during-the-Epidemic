                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>通知名称</label>
                                        <input type="text" id="tongzhiNameSearch" placeholder="请输入通知名称" aria-controls="tableId" class="form-control form-control-sm">
                                                                         
                                        <label>通知类型</label>
                                        <select name="tongzhiTypesSelectSearch" id="tongzhiTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="tongzhiExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/tongzhiMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('tongzhi_name')">通知名称<i id="tongzhiNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('tongzhi_photo')">通知图片<i id="tongzhiPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('tongzhi_types')">通知类型<i id="tongzhiTypesIcon" class="fa fa-sort"></i></th>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(tongzhiNameCell);
                ...
                //通知图片
            var tongzhiPhotoCell = document.createElement('td');
            var tongzhiPhotoImg = document.createElement('img');
            var tongzhiPhotoImgValue = baseUrl+item.tongzhiPhoto;
            if(tongzhiPhotoImgValue !=null && tongzhiPhotoImgValue !='' && tongzhiPhotoImgValue !='null'){
                tongzhiPhotoImg.setAttribute('src', tongzhiPhotoImgValue);
                tongzhiPhotoImg.setAttribute('height', 100);
                tongzhiPhotoImg.setAttribute('width', 100);
                tongzhiPhotoCell.appendChild(tongzhiPhotoImg);
            }else{
                tongzhiPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(tongzhiPhotoCell);
        ...
        function upload() {
            /*导入数据*/
            $('#tongzhiExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("tongzhi/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
