                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 xueyuanTypesDiv">
                                        <label>学院</label>
                                        <select style="width: 450px" id="xueyuanTypesSelect" name="xueyuanTypes" class="form-control"></select>
                                    </div>
                                    <div class="form-group col-md-6 banjiTypesDiv">
                                        <label>班级</label>
                                        <select style="width: 450px" id="banjiTypesSelect" name="banjiTypes" class="form-control"></select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 jinyongTypesDiv">
                                        <label>账户状态</label>
                                        <select style="width: 450px" id="jinyongTypesSelect" name="jinyongTypes" class="form-control"></select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationXueyuanTypesSelect(){
            ...
            if(xueyuanTypesSelect != null && xueyuanTypesOptions != null  && xueyuanTypesOptions.length > 0 ){
                xueyuanTypesSelect.options.length=0;
        ...
        function initializationBanjiTypesSelect(){
            ...
            if(banjiTypesSelect != null && banjiTypesOptions != null  && banjiTypesOptions.length > 0 ){
                banjiTypesSelect.options.length=0;
        ...
        function initializationJinyongTypesSelect(){
            ...
            if(jinyongTypesSelect != null && jinyongTypesOptions != null  && jinyongTypesOptions.length > 0 ){
                jinyongTypesSelect.options.length=0;
    ...
    function setSelectOption() {
        ...
        if(jinyongTypesSelect != null && jinyongTypesOptions != null  && jinyongTypesOptions.length > 0 ) {
            for (var i = 0; i < jinyongTypesOptions.length; i++) {
                if (jinyongTypesOptions[i].codeIndex == ruleForm.jinyongTypes) {//下拉框value对比,如果一致就赋值汉字
                        jinyongTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function getDetails() {
        ...
        if (addxuesheng != null && addxuesheng != "" && addxuesheng != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='xuesheng'){
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="xuesheng"){//个人中心修改
                $(".jinyongTypesDiv").remove();//禁用删除掉
            }
        }
        else{
            // alert("未知情况.......");
