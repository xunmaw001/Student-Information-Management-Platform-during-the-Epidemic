            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学校文件收藏登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="wenjianbiaoId" name="wenjianbiaoId" v-model="ruleForm.wenjianbiaoId" readonly type="hidden">
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input style="width: 450px" id="wenjianbiaoCollectionValue" name="wenjianbiaoCollectionValue" class="form-control"
                                           v-model="ruleForm.wenjianbiaoCollectionValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "wenjianbiaoCollection/info/" + id,
