            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">接受地前往登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jieshoudiId" name="jieshoudiId" v-model="ruleForm.jieshoudiId" readonly type="hidden">
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jieshoudiQianwangUuidNumber" name="jieshoudiQianwangUuidNumber" class="form-control"
                                               v-model="ruleForm.jieshoudiQianwangUuidNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>前往类型</label>
                                    <input style="width: 450px" id="jieshoudiQianwangValue" name="jieshoudiQianwangValue" class="form-control"
                                           v-model="ruleForm.jieshoudiQianwangValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>前往时间</label>
                                        <input style="width: 450px" id="qianwangTime" name="qianwangTime" class="form-control"
                                               v-model="ruleForm.qianwangTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>抵达时间</label>
                                        <input style="width: 450px" id="didaTime" name="didaTime" class="form-control"
                                               v-model="ruleForm.didaTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jieshoudiQianwang/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jieshoudiQianwangContent != null && ruleForm.jieshoudiQianwangContent != 'null' && ruleForm.jieshoudiQianwangContent != '') {
            var jieshoudiQianwangContentUeditor = UE.getEditor('jieshoudiQianwangContentEditor');
                jieshoudiQianwangContentUeditor.ready(function () {
                    ...
                    jieshoudiQianwangContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var jieshoudiQianwangFileUrl = "download('" + ruleForm.jieshoudiQianwangFile + "')";
        $("#jieshoudiQianwangFile").attr("onclick", jieshoudiQianwangFileUrl);
