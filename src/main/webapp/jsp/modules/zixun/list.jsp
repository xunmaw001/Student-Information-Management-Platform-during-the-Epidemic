...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">资讯列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">资讯列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                                                         
                                        <label>资讯名称</label>
                                        <input type="text" id="zixunNameSearch" placeholder="请输入资讯名称" aria-controls="tableId" class="form-control form-control-sm">
                                                                         
                                        <label>资讯类型</label>
                                        <select name="zixunTypesSelectSearch" id="zixunTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="zixunExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/zixunMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('zixun_name')">资讯名称<i id="zixunNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zixun_photo')">资讯图片<i id="zixunPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zixun_types')">资讯类型<i id="zixunTypesIcon" class="fa fa-sort"></i></th>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            var zixunPhotoImgValue = baseUrl+item.zixunPhoto;
        ...
        function upload() {
            /*导入数据*/
            $('#zixunExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("zixun/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
