...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">每日记录管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">每日记录管理</li>
                            <li class="breadcrumb-item active">每日记录列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">每日记录列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                                                                                                                                 
                                        <label>记录标题</label>
                                        <input type="text" id="xueshengJiluNameSearch" placeholder="请输入记录标题" aria-controls="tableId" class="form-control form-control-sm">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="xueshengJiluExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/xueshengJiluMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('xuesheng_jilu_uuid_number')">每日记录编号<i id="xueshengJiluUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('xuesheng_jilu_name')">记录标题<i id="xueshengJiluNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('xuesheng_jilu_file')">记录附件<i id="xueshengJiluFileIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('xuesheng_jilu_time')">所属日期<i id="xueshengJiluTimeIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //记录标题
            var xueshengJiluNameSearchInput = $('#xueshengJiluNameSearch');
            if( xueshengJiluNameSearchInput != null){
                if (xueshengJiluNameSearchInput.val() != null && xueshengJiluNameSearchInput.val() != '') {
                    searchForm.xueshengJiluName = $('#xueshengJiluNameSearch').val();
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("xueshengJilu/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                xueshengJiluDelete: 1,
                //本表的
                xueshengJiluName: searchForm.xueshengJiluName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //每日记录编号
            var xueshengJiluUuidNumberCell = document.createElement('td');
            xueshengJiluUuidNumberCell.innerHTML = item.xueshengJiluUuidNumber;
            row.appendChild(xueshengJiluUuidNumberCell);


            //记录标题
            var xueshengJiluNameCell = document.createElement('td');
            xueshengJiluNameCell.innerHTML = item.xueshengJiluName;
            row.appendChild(xueshengJiluNameCell);


                //记录附件
            var xueshengJiluFileCell = document.createElement('td');
            if(item.xueshengJiluFile ==null || item.xueshengJiluFile == '' || item.xueshengJiluFile == 'null'){
                    xueshengJiluFileCell.innerHTML = '没有下载文件';
            }else {
                var xueshengJiluFileFile = document.createElement('button');
                    xueshengJiluFileFile.innerHTML = '下载';
                var xueshengJiluFileFileAttr = "download('" + item.xueshengJiluFile + "')"
                    xueshengJiluFileFile.setAttribute('onclick',xueshengJiluFileFileAttr);
                    xueshengJiluFileCell.appendChild(xueshengJiluFileFile);
            }
            row.appendChild(xueshengJiluFileCell);


            //所属日期
            var xueshengJiluTimeCell = document.createElement('td');
            xueshengJiluTimeCell.innerHTML = item.xueshengJiluTime;
            row.appendChild(xueshengJiluTimeCell);
        ...
        function upload() {
            /*导入数据*/
            $('#xueshengJiluExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("xueshengJilu/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xueshengJilu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("xueshengJilu/update", "POST", {
                    id:id,
                    xueshengJiluTypes:2
                }, (res) => {
                    if(res.code == 0){
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxueshengJilu", "addxueshengJilu");
            window.location.href = "add-or-update.jsp"
        }
...
// 101 102 103 104 105
            ...
            function chartDialog(){
                ...
                //    groupColumn: "xuesheng_jilu_types",
                //    // riqi:echartsDate
                //}, (res) => {//pieSum pieCount
                //    if (res && res.code === 0) {
                //        let data = res.data;
