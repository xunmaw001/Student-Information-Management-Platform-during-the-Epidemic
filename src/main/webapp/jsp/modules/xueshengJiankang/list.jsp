...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">学生健康管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">学生健康列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">学生健康列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                                                                                                                                                                     
                                        <label>健康状态</label>
                                        <select name="xueshengJiankangTypesSelectSearch" id="xueshengJiankangTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="xueshengJiankangExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/xueshengJiankangMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('xuesheng_jiankang_uuid_number')">记录编号<i id="xueshengJiankangUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('xuesheng_jiankang_file')">附件<i id="xueshengJiankangFileIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('xuesheng_jiankang_types')">健康状态<i id="xueshengJiankangTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('suoshu_time')">所属日期<i id="suoshuTimeIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(jinyongTypesSelectSearchInput != null){
                ...
                //健康状态
            var xueshengJiankangTypesSelectSearchInput = document.getElementById("xueshengJiankangTypesSelectSearch");
            if(xueshengJiankangTypesSelectSearchInput != null){
                var xueshengJiankangTypesIndex = xueshengJiankangTypesSelectSearchInput.selectedIndex;
                if( xueshengJiankangTypesIndex  != 0){
                    searchForm.xueshengJiankangTypes= document.getElementById("xueshengJiankangTypesSelectSearch").options[xueshengJiankangTypesIndex].value;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("xueshengJiankang/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,//字段
                order: sortOrder,//asc desc
                xueshengJiankangDelete: 1,
                //本表的
                xueshengJiankangTypes: searchForm.xueshengJiankangTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //记录编号
            var xueshengJiankangUuidNumberCell = document.createElement('td');
            xueshengJiankangUuidNumberCell.innerHTML = item.xueshengJiankangUuidNumber;
            row.appendChild(xueshengJiankangUuidNumberCell);


                //附件
            var xueshengJiankangFileCell = document.createElement('td');
            if(item.xueshengJiankangFile ==null || item.xueshengJiankangFile == '' || item.xueshengJiankangFile == 'null'){
                    xueshengJiankangFileCell.innerHTML = '没有下载文件';
            }else {
                var xueshengJiankangFileFile = document.createElement('button');
                    xueshengJiankangFileFile.innerHTML = '下载';
                var xueshengJiankangFileFileAttr = "download('" + item.xueshengJiankangFile + "')"
                    xueshengJiankangFileFile.setAttribute('onclick',xueshengJiankangFileFileAttr);
                    xueshengJiankangFileCell.appendChild(xueshengJiankangFileFile);
            }
            row.appendChild(xueshengJiankangFileCell);


            //健康状态
            var xueshengJiankangTypesCell = document.createElement('td');
            xueshengJiankangTypesCell.innerHTML = item.xueshengJiankangValue;
            row.appendChild(xueshengJiankangTypesCell);


            //所属日期
            var suoshuTimeCell = document.createElement('td');
            suoshuTimeCell.innerHTML = item.suoshuTime;
            row.appendChild(suoshuTimeCell);
        ...
        function upload() {
            /*导入数据*/
            $('#xueshengJiankangExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("xueshengJiankang/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("xueshengJiankang/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("xueshengJiankang/update", "POST", {
                    id:id,
                    xueshengJiankangTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addxueshengJiankang", "addxueshengJiankang");
            window.location.href = "add-or-update.jsp"
        }
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'xueshengJiankang.xlsx'
            });
            excel.generate();
        }
    ...
    //填充本表搜索下拉框
        ...
        function xueshengJiankangTypesSelectSearch() {
            var xueshengJiankangTypesSelectSearch = document.getElementById('xueshengJiankangTypesSelectSearch');
            if(xueshengJiankangTypesSelectSearch != null) {
                xueshengJiankangTypesSelectSearch.add(new Option('-请选择-',''));
                if (xueshengJiankangTypesOptions != null && xueshengJiankangTypesOptions.length > 0){
                    for (var i = 0; i < xueshengJiankangTypesOptions.length; i++) {
                            xueshengJiankangTypesSelectSearch.add(new Option(xueshengJiankangTypesOptions[i].indexName,xueshengJiankangTypesOptions[i].codeIndex));
                    }
                }
            }
        }
...
// 101 102 103 104 105
            ...
            function chartDialog(){
                ...
                //    groupColumn: "xuesheng_jiankang_types",
                //    // riqi:echartsDate
                //}, (res) => {//pieSum pieCount
                //    if (res && res.code === 0) {
                //        let data = res.data;
        ...
        //当前表的下拉框赋值
            ...
            xueshengJiankangTypesSelectSearch();
