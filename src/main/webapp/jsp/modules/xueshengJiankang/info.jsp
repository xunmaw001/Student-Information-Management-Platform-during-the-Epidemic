            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生健康登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xueshengJiankangUuidNumber" name="xueshengJiankangUuidNumber" class="form-control"
                                               v-model="ruleForm.xueshengJiankangUuidNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>健康状态</label>
                                    <input style="width: 450px" id="xueshengJiankangValue" name="xueshengJiankangValue" class="form-control"
                                           v-model="ruleForm.xueshengJiankangValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>所属日期</label>
                                        <input style="width: 450px" id="suoshuTime" name="suoshuTime" class="form-control"
                                               v-model="ruleForm.suoshuTime" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xueshengJiankang/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.xueshengJiankangContent != null && ruleForm.xueshengJiankangContent != 'null' && ruleForm.xueshengJiankangContent != '') {
            var xueshengJiankangContentUeditor = UE.getEditor('xueshengJiankangContentEditor');
                xueshengJiankangContentUeditor.ready(function () {
                    ...
                    xueshengJiankangContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var xueshengJiankangFileUrl = "download('" + ruleForm.xueshengJiankangFile + "')";
        $("#xueshengJiankangFile").attr("onclick", xueshengJiankangFileUrl);
