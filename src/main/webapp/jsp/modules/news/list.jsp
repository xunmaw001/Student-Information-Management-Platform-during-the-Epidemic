...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>新闻名称</label>
                                        <input type="text" id="newsNameSearch" placeholder="请输入新闻名称" aria-controls="tableId" class="form-control form-control-sm">
                                                                         
                                        <label>新闻类型</label>
                                        <select name="newsTypesSelectSearch" id="newsTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="newsExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/newsMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('news_name')">新闻名称<i id="newsNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('news_photo')">新闻图片<i id="newsPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('news_types')">新闻类型<i id="newsTypesIcon" class="fa fa-sort"></i></th>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            var newsPhotoImgValue = baseUrl+item.newsPhoto;
        ...
        function upload() {
            /*导入数据*/
            $('#newsExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("news/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
