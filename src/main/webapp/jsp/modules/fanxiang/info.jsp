            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">返校申请登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fanxiangUuidNumber" name="fanxiangUuidNumber" class="form-control"
                                               v-model="ruleForm.fanxiangUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fanxiangName" name="fanxiangName" class="form-control"
                                               v-model="ruleForm.fanxiangName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fanxiangAddress" name="fanxiangAddress" class="form-control"
                                               v-model="ruleForm.fanxiangAddress" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>返校申请类型</label>
                                    <input style="width: 450px" id="fanxiangValue" name="fanxiangValue" class="form-control"
                                           v-model="ruleForm.fanxiangValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>返校方式</label>
                                    <input style="width: 450px" id="fanxiangFangshiValue" name="fanxiangFangshiValue" class="form-control"
                                           v-model="ruleForm.fanxiangFangshiValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>返校路径</label>
                                        <input style="width: 450px" id="fanxiangLujing" name="fanxiangLujing" class="form-control"
                                               v-model="ruleForm.fanxiangLujing" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>预计到校日期</label>
                                        <input style="width: 450px" id="daoxiaoTime" name="daoxiaoTime" class="form-control"
                                               v-model="ruleForm.daoxiaoTime" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>申请状态</label>
                                    <input style="width: 450px" id="fanxiangYesnoValue" name="fanxiangYesnoValue" class="form-control"
                                           v-model="ruleForm.fanxiangYesnoValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>回复话语</label>
                                        <input style="width: 450px" id="fanxiangYesnoText" name="fanxiangYesnoText" class="form-control"
                                               v-model="ruleForm.fanxiangYesnoText" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>审核时间</label>
                                        <input style="width: 450px" id="fanxiangShenheTime" name="fanxiangShenheTime" class="form-control"
                                               v-model="ruleForm.fanxiangShenheTime" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.fanxiangContent != null && ruleForm.fanxiangContent != 'null' && ruleForm.fanxiangContent != '') {
            var fanxiangContentUeditor = UE.getEditor('fanxiangContentEditor');
                fanxiangContentUeditor.ready(function () {
                    ...
                    fanxiangContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var fanxiangFileUrl = "download('" + ruleForm.fanxiangFile + "')";
        $("#fanxiangFile").attr("onclick", fanxiangFileUrl);
