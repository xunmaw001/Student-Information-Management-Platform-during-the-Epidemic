...
public class XueshengJiluView extends XueshengJiluEntity implements Serializable {
	...
	public XueshengJiluView() {

	}

	public XueshengJiluView(XueshengJiluEntity xueshengJiluEntity) {
		try {
			BeanUtils.copyProperties(this, xueshengJiluEntity);
