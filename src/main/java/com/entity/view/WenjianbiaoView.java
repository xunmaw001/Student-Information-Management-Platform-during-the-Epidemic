...
public class WenjianbiaoView extends WenjianbiaoEntity implements Serializable {
	...
	*/
	...
	public WenjianbiaoView() {

	}

	public WenjianbiaoView(WenjianbiaoEntity wenjianbiaoEntity) {
		try {
			BeanUtils.copyProperties(this, wenjianbiaoEntity);
	...
	*/
	...
	public String toString() {
		return "WenjianbiaoView{" +
			", wenjianbiaoValue=" + wenjianbiaoValue +
